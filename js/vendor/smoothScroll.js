  ...
  return (function (t) {
    ...
    function (t, n, e) {
      ...
      function R(t) {
        function n(n, e) {
          ...
          if (n === Yt.Y) {
            return (
              (e /
                (r.container.height +
                  (p.thumb.realSize - p.thumb.displaySize))) *
              r.content.height
            );
          }
          return 0;
        ...
        function e(t) {
          return E(t, [l.element, l.thumb.element])
            ? Yt.X
            : E(t, [p.element, p.thumb.element])
            ? Yt.Y
            : void 0;
        }
        var r,
      ...
      function G(t) {
        ...
        return "wheelDeltaX" in t
          ? { x: t.wheelDeltaX / Kt.OTHERS, y: t.wheelDeltaY / Kt.OTHERS }
          : { x: 0, y: t.wheelDelta / Kt.OTHERS };
      }
      function V() {
      ...
      var Wt,
        ...
        Bt = (function () {
          ...
          return (
            ...
            (t.prototype.update = function (t, n, e) {
              O(this.element, { display: e <= n ? "none" : "block" }),
        ...
        Zt = (function () {
          ...
          return (
            ...
            (t.prototype._nextTick = function (t) {
              ...
              var c = u * (1 - e.damping);
              return (
                e.renderByPixels && (c |= 0),
                { momentum: c, position: i + u - c }
              );
            }),
          ...
          ("__proto__" in {}
            ? (function (t, n, r) {
                try {
                  (r = e(10)(
                    Function.call,
                    e(74).f(Object.prototype, "__proto__").set,
                    2
                  )),
                    r(t, []),
